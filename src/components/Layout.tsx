...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <Link
        to="/contact"
        className="fixed bottom-6 right-6 bg-blue-600 text-white p-3 rounded-full shadow-lg hover:bg-blue-700 transition-all hover:scale-110 z-40"
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold">EthicBizz</span>
              </div>
              <p className="text-gray-300 mb-4 max-w-md">
                Empowering the next generation through ethical business education, 
                real-world application, and transformative learning experiences.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                <li><Link to="/programs/ydp" className="hover:text-white">Youth Development</Link></li>
                <li><Link to="/programs/ssp" className="hover:text-white">Senior Secondary</Link></li>
                <li><Link to="/programs/epc" className="hover:text-white">Professional Core</Link></li>
                <li><Link to="/programs/erwa" className="hover:text-white">Real-World Application</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                ...
                <li><Link to="/mentors" className="hover:text-white">Become a Mentor</Link></li>
                <li><Link to="/schools" className="hover:text-white">Partner Schools</Link></li>
